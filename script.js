...
const albums = [
  ...
  },
  {
    ...
    cover: "/placeholder.svg?height=300&width=300",
    tracks: [
      { name: "Focus Flow", duration: "4:02", file: "/audio/track6.mp3" },
      { name: "Peaceful Mind", duration: "3:36", file: "/audio/track7.mp3" },
      { name: "Library Ambience", duration: "3:51", file: "/audio/track8.mp3" },
      {
        name: "Deep Concentration",
        duration: "4:28",
        file: "/audio/track9.mp3",
      },
      { name: "Study Break", duration: "2:44", file: "/audio/track10.mp3" },
    ],
  },
  {
    id: 3,
